...
module vector_alu_tb;
  ...
  task test_case(input [7:0] test_number, input [2:0] tc_operation,
  ...
  initial begin
    ...
    test_case(.test_number(1), .tc_operation(`HALT_OR_VECTOR_SUBOP_VADD),
              .expected_out(128'h0058_004D_0042_0037_002C_0021_0016_000B));
    test_case(.test_number(2), .tc_operation(`HALT_OR_VECTOR_SUBOP_VSUB),
              .expected_out(128'h0048_003F_0036_002D_0024_001B_0012_0009));
    test_case(.test_number(3), .tc_operation(`HALT_OR_VECTOR_SUBOP_VMUL),
              .expected_out(128'h0280_01EA_0168_00FA_00A0_005A_0028_000A));
    test_case(.test_number(4), .tc_operation(`HALT_OR_VECTOR_SUBOP_VDOT),
              .expected_out(128'h0280_01EA_0168_00FA_00A0_005A_0028_000A));
