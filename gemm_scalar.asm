# Matrix multiplication of matrix A size (M x N) and matrix B size (N x P) using CPU scalar instructions
#
...
# Register Layout:
# r1: N, then the increment (1)
# r2: A pointer (A base + i*N)
# r3: B^T pointer (B^T base + j*N)
# r4: scratch (i*N, then the A element)
# r5: scratch (j*N, then the B element)
